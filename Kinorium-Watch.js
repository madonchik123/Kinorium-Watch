...
const BANNER_ID = 'kinorium-watch';
const MOVIE_TYPES = ['/'];
const PLAYER_LINK = 'https://CheapBlueReality.crispypiez.repl.co/?data';
...
function init() {
	...
	// Initialize
	updateBanner();
	console.log('Kinorium Watch started! 🎥');
}
